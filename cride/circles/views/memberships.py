...
class MembershipViewSet(mixins.ListModelMixin,
        ...
        def invitations(self, request, *args, **kwargs):
            ...
            data = {
                'used_invitations': MembershipModelSerializer(invited_members, many=True).data, #Le estamos pasando el filtro del modelo y le decimos que hay muchos objetos
        ...
        def create(self, request, *args, **kwargs):
            ...
            data = self.get_serializer(member).data #obtiene el que esta en serializer_class
