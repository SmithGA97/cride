    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified', models.BooleanField(default=False, help_text='Verified circles are also know as official communitties', verbose_name='verified circles')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited this will be limit on the number of members')),
            ],
            options={
